...
import { assertValidTransition, resolveRequestPublishState, toContentState } from "@/lib/contentLifecycle";
...
export async function POST(
  ...
  const hasVideoAsset = content.assets.some((asset) => asset.kind === "VIDEO");
  const toState = resolveRequestPublishState(content.type, hasVideoAsset);
